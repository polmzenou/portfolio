document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll("a, button, .project-card, .flip-card, .social-icon").forEach((el) => {
    ...
    document.querySelectorAll(".fade-in, .project-card, .section-title").forEach(el => {
        observer.observe(el);
    });
